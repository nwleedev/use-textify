...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      ...
      {
        src: "/static/apple-icon-60x60.png",
        sizes: "60x60",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-72x72.png",
        sizes: "72x72",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-76x76.png",
        sizes: "76x76",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-114x114.png",
        sizes: "114x114",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-120x120.png",
        sizes: "120x120",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-144x144.png",
        sizes: "144x144",
        type: "image/png",
      },
      {
        src: "/static/apple-icon-152x152.png",
        sizes: "152x152",
        type: "image/png",
      },
      {
      ...
      {
        src: "/static/apple-icon-precomposed.png",
        sizes: "192x192",
        type: "image/png",
      },
      {
      ...
      {
        src: "/static/ms-icon-70x70.png",
        sizes: "70x70",
        type: "image/png",
      },
      {
        src: "/static/ms-icon-144x144.png",
        sizes: "144x144",
        type: "image/png",
      },
      {
        src: "/static/ms-icon-150x150.png",
        sizes: "150x150",
        type: "image/png",
      },
      {
