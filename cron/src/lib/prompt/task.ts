export function createFeedPrompt(concept: string) {
  ...
  Variables are the variables required for prompts. Each variable item must consist of a variable and a variable description. A variable description is a single sentence consisting of 14-16 words about what a variable does. If a variable is written in a prompt, it must also be specified in a variable item. For example, if the prompt specifies ... {{text}} ... or ... {{title}} ..., the variable list must have a text, or title item.
