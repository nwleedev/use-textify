...
- Prompt: Please write the prompt consisting of about 200 words as much as possible. If the topic is wide-spread, you should divide to multiple steps and format into the nested list, and each list item should be about 35 words.
